                ...
                child: Column(
                  children: [
                    _ProjectTile(
                      ...
                      desc:
                          'Calculates age from date of birth with a clean Material UI.',
                    ...
                    _ProjectTile(
                      ...
                      desc:
                          'Generates monthly payslips with deductions and formatted output.',
                    ...
                    _ProjectTile(
                      title: 'Audio Player',
                      desc:
                          'Cross-platform audio player with web-safe fallback support.',
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(desc, style: const TextStyle(fontSize: 12, color: _mid)),
              ],
            ),
          ),
        ],
